...
const texts = [
    ...
    "Local residents have taken actions to try and fix this problem.  Citing their work is reliable because they are first-hand witnesses to what it's like to live in Springfield and they have actually worked on fixing the problem.  For example, Paul Tuthill has shared his ideas for the defense of existing buisness owners and future big buisnesses. Check his work out in this <a id='LinkedText' href='https://www.wamc.org/new-england-news/2013-06-21/plan-aims-to-change-public-safety-perception-of-downtown-springfield'>WAMC Article</a>",
    "One possible strategy for non-residents is that people wanting to start a business can choose the safest neighborhoods.  There are many crime maps that show parts of Springfield from most dangerous to most safe like this one, which is reliable because it comes from an organization that monitors crime all over the Un.S.  <a id='LinkedText' href='https://crimegrade.org/safest-places-in-springfield-ma/'>this crime map.</a> you can download crime info on this website.",
