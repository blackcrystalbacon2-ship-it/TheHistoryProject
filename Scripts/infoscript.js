...
const texts = [
    ...
    "Springfield has a problem with a negative reputation - people think that it is a dangerous place to visit, live, and start a business.",
    "This can affect local buisnesses, and cause people to loose opprotunities for their buisness to succeed. The reputation of Springfield drives customers away to other towns they think are safer...",
    "Local residents have taken actions to try and fix this problem. Citing their work is reliable because they're first-hand witnesses to what it's like to live in Springfield and they have actually worked on fixing the problem.  For example, Paul Tuthill has shared his ideas for the defense of existing buisness owners and future big buisnesses. Check his work out in this <a id='LinkedText' href='https://www.wamc.org/new-england-news/2013-06-21/plan-aims-to-change-public-safety-perception-of-downtown-springfield'>WAMC Article</a>",
    "One possible strategy for non-residents is that people wanting to start a business can choose the safest neighborhoo ds.  There are many crime maps that show parts of Springfield from most dangerous to most safe like this one, which is reliable because it comes from an organization that monitors crime all over the U.S.  <a id='LinkedText' href='https://crimegrade.org/safest-places-in-springfield-ma/'>this crime map.</a> you can download crime info on this website.",
    "I may be risking backlash from people who live and work in 'dangerous' parts of Springfield by promoting safer parts over the possibly dangerous parts, but thats why I also want the neighborhoods with less saftety to have support to help them improve their safety and reputation",
    ...
    "An example elsewhere of a solution to a similar problem working is from <a id = 'LinkedText' href='https://www.urban.org/stories/creating-lasting-change-through-community-leadership'>Camden, New Jersey</a> where the public image was that the area, in New Jersey, was hopeless, stuck in a cycle of poverty. I can address pushback from people who don't believe revival of neighborhoods is possible by sharing their story.  You can read more about the actions local residents took from the link."
    ...
    ,"Local residents in more dangerous parts can patrol their neighborhoods to increase safety, and they could use your support.  To help spread awareness of this problem and support local peoples' hard work, you can make a donation to support local neighborhood crime watch crews in Springfield: <a id = 'DonateSite' href = 'Funding.html'>Site</a> ",
